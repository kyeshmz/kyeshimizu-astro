...
import img2 from './images/fencing-visualized/fencing_02.jpg'
...
<Spacer size={16} />
  <Picture widths={[360, 768, 1024, 1440]} src={img2} formats={['avif', 'webp']} alt='A person watching a screen of the works'  sizes={'(min-width: 360px) (min-width: 768px) (min-width:1024px)  (min-width:1440px)'} />
<Spacer size={32} />
<TextSection>
  <p>
