...
例えば、[UE on AWS から引用した構成図](https://aws.amazon.com/jp/blogs/news/jpmne-virtual-production-reference-architecture-with-epic-games-unreal-engine/)みたいなものも実はTDで作ることもできるのではないでしょうか
