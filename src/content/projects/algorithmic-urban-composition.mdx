...
<Picture widths={[400, 800, 1200, 1400, 2000]} src={img4} formats={['avif', 'webp']} alt='A person watching a screen of the works' />
<div className="flex md:flex-row flex-col gap-4 flex-wrap">
<Picture widths={[400, 800, 1200, 1400, 2000]} src={img3} formats={['avif', 'webp']} alt='A person watching a screen of the works' />

<Picture widths={[400, 800, 1200, 1400, 2000]} src={img5} formats={['avif', 'webp']} alt='A person watching a screen of the works' />
</div>
