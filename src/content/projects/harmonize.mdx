...
credits:
  [
    'Digital Fabrication Engineering & Lighting Coordination : Kye Shimizu',
    'Software Engineering : NOIZ',
    'Design Research: Kotaro Sano, Kazuya Kawasaki',
    'Supervision : Daijiro Mizuno',
    'Art direction & Production : YUIMA NAKAZATO staff',
  ]
